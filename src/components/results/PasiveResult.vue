<template>
    <Result :title=title :icon=icon :customStyle=style>
        <div slot="info">
            <p>No dices lo que piensas ni te haces respetar. El miedo a lo que otros piensen de ti, 
...
export default class PasiveResult extends Vue {
